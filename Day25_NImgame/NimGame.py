...
def return_players(default_computer_name="Alpha NIM"):
    ...
    while True:
        ...
        player_b_name = input(
            "Enter player B name or enter 'computer' for computer player: ")
    ...
    if player_b_name == "computer":
        ...
        game_level = input(
            "Select level of the game - fixed, random or smart: ")
        if game_level == "fixed":
            return get_level(1)
        elif game_level == "random":
            return get_level(2)
        else:
            return get_level(3)
        return (HumanPlayer(player_a_name), ComputerPlayer(default_computer_name), level())
    else:
